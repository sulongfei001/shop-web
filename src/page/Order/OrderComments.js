...
import OrderCommentDetails from "./OrderCommentDetails";
import Page from "../../ui/Page/Page";

class OrderComments extends Page {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div>
                            ...
                            <FixedTop>
                                <div className="status-list">
                                    <div className="status-link">
                                        <a onClick={() => this.props.history.replace(match.url.replace('comments', 'noComments'))}>待评价</a>
                                        <a>已评价</a>
                                    </div>
                                    <div className="status-active2" />
                                </div>
                            </FixedTop>
                        }
                                ...
                                {goodsList.map(g =>
                                    <div key={g.expressId + '_' + g.skuId} className="goods-item">
                                        ...
                                        <div className="buttons">
                                            <Link to={match.url + '/details/' + g.commentsId + '/' + encodeURIComponent(g.logo)}>查看评价</Link>
                ...
                <Route path={match.url + '/details/:commentsId/:logo'} component={OrderCommentDetails} />
            </div>
        );
    }
}
