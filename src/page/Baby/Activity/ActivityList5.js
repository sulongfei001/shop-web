...
class ActivityList5 extends Page {
    constructor(props) {
        super(props);
        this.state = {
            showTitle: false,
    ...
    btnMouseDown = () => {
        let { btn } = this.state;
        btn.style.backgroundColor = "#ADA502";
        this.setState({
            btn: btn
        });
    }
    btnMouseUp = () => {
        let { btn } = this.state;
        btn.style.backgroundColor = "#C7BD02";
        this.setState({
            btn: btn
        });
    }
    ...
    render() {
        ...
        return (
            <div>
                {!showTitle &&
                    <TopTitle title="直播棚录报名" style={{ backgroundColor: "" }} onClickBack={() => { history.goBack(); }} />}
                <TransitionGroup>
                    {showTitle && <Fade>
                        <TopTitle title="直播棚录报名" style={{ backgroundColor: "#333333" }} onClickBack={() => { history.goBack(); }} />
                    </Fade>}
                </TransitionGroup>
