...
import ApplySuccessTitle from "../img/ApplySuccessTitle5.png";
...
class ApplySuccess5 extends Page {
    constructor(props) {
        super(props);
        this.state = {};
        Screen.loading(true);
