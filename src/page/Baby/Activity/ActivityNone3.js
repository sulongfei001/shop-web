    ...
    render() {
        ...
        return (
            <div>
                ...
                <FullScreenPage style={{ background: '#FCE7DC', zIndex: -1 }} />
                <div className="ActivityNone3" style={{ backgroundImage: 'url(' + PhotoBalloon + '),url(' + PhotoDog + ')' }}>
                    <div className="ActivityIntroduce">
                        ...
                        <div className="IntroduceDown">
                            ...
                            <div className="content">
                                <span>会员有效期内，满足以下报名条件的用户即可参与报名平面模特海选活动。<br /></span>
                                <p>年龄要求：</p>
                            ...
                            <p>二、取消规则：</p>
                            <div className="content">
                                <span>如有特殊原因需取消已报名的平面模特海选活动，需在平面模特海选活动开始前24小时以上，发送【取消报名】至公众号咿呀咿呀，收到取消成功的明确回复后，视为取消成功。<br /></span>
                                <span>未能及时取消或无故缺席的用户视为本次机会已使用，将自缺席之日起1周内无法报名平面模特海选活动。<br /></span>
                            </div>
                            <br />
                            <p>三、海选结果：</p>
                            <div className="content">
                                ...
                                <br />
                                <p>特别说明：</p>
                                <span >平面模特入选后，敬请等待拍摄通知，入选后1个月等待期内无法报名平面模特海选活动。<br /></span>
                    ...
                    <div className="VIPIntroduce">
                        ...
                        <div className="IntroduceDown">
                            <p>成为咿呀咿呀星愿卡 V3 会员，</p>
                            <p>可参与宝宝平面模特海选报名，</p>
                            <p>报名成功后可参与平面模特海选活动，</p>
                            <p>成功入选的宝贝</p>
                            <p>可获得咿呀咿呀品牌平面模特拍摄的机会哦！</p>
                        </div>
                    </div>
