...
import ApplySessionTitle from "../img/ApplySessionTitle3.png";
...
class ActivityList3 extends Page {
    constructor(props) {
        super(props);
        this.state = {
            showTitle: false,
    ...
    btnMouseDown = () => {
        let { btn } = this.state;
        btn.style = { backgroundColor: "#e5a27e" };
        this.setState({
            btn: btn
        });
    }
    btnMouseUp = () => {
        let { btn } = this.state;
        btn.style = { backgroundColor: "#FFB48C" };
        this.setState({
            btn: btn
        });
    }
