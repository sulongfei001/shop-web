import "./ApplyAuditions3.css";
import React from 'react';
import Page from "../../../ui/Page/Page";
import UserContext from "../../../model/UserContext";
import ActivityApi from "../../../api/BabyActivityApi";
import ApplyAuditionTitle from "../img/ApplyAuditionsTitle3.png";
...
class ApplyAuditions3 extends Page {
    constructor(props) {
        super(props);
        this.state = {
            babyAuditionId: "",
    ...
    render() {
        ...
        return (
            <div>
                <TopTitle title="平面模特报名" onClickBack={() => { history.goBack(); }} />
                <FullScreenPage style={{background: '#FFEEE5', zIndex: -1}}/>
                <div className="ApplyAuditions3">
...
export default ApplyAuditions3;