...
import ApplySuccessTitle from "../img/ApplySuccessTitle3.png";
...
class ApplySuccess3 extends Page {
    constructor(props) {
        super(props);
        this.state = {};
        Screen.loading(true);
