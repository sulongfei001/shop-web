import "./ApplyAuditionsPass1.css";
...
import ApplyPass from "../img/ApplyPass1.png";
...
class ApplyAuditionsPass1 extends Page {
    constructor(props) {
        super(props);
        this.state = {
            showTitle: false
    ...
    render() {
        ...
        return (
            <div className="ApplyAuditionsPass1" style={{ backgroundImage: 'url(' + PhotoDog + '),url(' + PhotoBalloon + ')' }}>
                {!showTitle &&
...
export default ApplyAuditionsPass1;