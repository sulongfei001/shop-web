import "./ApplyAuditionsPass3.css";
...
import ApplyPass from "../img/ApplyPass3.png";
...
class ApplyAuditionsPass3 extends Page {
    constructor(props) {
        super(props);
        this.state = {
            showTitle: false
    ...
    render() {
        ...
        return (
            <div className="ApplyAuditionsPass3" style={{ backgroundImage: 'url(' + PhotoDog + '),url(' + PhotoBalloon + ')' }}>
                {!showTitle &&
                ...
                <FullScreenPage style={{ background: '#FFEEE5', zIndex: -1 }} />
...
export default ApplyAuditionsPass3;