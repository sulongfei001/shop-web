import "./ApplyAuditionsPass5.css";
...
import ApplyPass from "../img/ApplyPass5.png";
...
class ApplyAuditionsPass5 extends Page {
    constructor(props) {
        super(props);
        this.state = {
            showTitle: false
    ...
    render() {
        ...
        return (
            <div className="ApplyAuditionsPass5" style={{ backgroundImage: 'url(' + PhotoDog + '),url(' + PhotoBalloon + ')' }}>
                {!showTitle &&
...
export default ApplyAuditionsPass5;